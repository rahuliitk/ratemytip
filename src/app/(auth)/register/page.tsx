  ...
  return (
    <Card>
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Join RateMyTip to follow creators, rate tips, and more
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              {usernameStatus === "available" && (
                <span className="absolute right-3 top-2 text-xs text-success">
                  Available
                </span>
              )}
              {usernameStatus === "taken" && (
                <span className="absolute right-3 top-2 text-xs text-danger">
                  Taken
                </span>
              )}
            </div>
